...
import { useTrustUsers } from "./use-trust-users";
...
export const TrustForm = () => {
  const { form, onSubmit, isCreating } = useTrustUsers();
  ...
  const handleCreateSubmit = async (values: CreateTrustUserFormValues) => {
    try {
  ...
  return (
    <Dialog open={isCreateOpen} onOpenChange={handleDialogChange}>
      ...
      <DialogContent className="sm:max-w-xl">
        <DialogHeader>
          <DialogTitle>Create Trust User</DialogTitle>
        </DialogHeader>
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="e.g., trust.member" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <UserPhotoUpload
              label="Profile Photo"
              personName={form.watch("name") || "Trust User"}
